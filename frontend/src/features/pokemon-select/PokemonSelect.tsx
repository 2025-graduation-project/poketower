  ...
  return (
    <div className="w-screen h-screen p-5 flex flex-col gap-16" style={{ boxSizing: 'border-box' }}>
      <div className="text-center">
        <div className="text-24 font-bold mb-2">스테이지 클리어!</div>
        <div className="text-16">출현한 포켓몬 중 5마리를 선택하여 PC에 저장하세요</div>
        <div className="text-14 mt-2">선택됨: {selectedIndices.length}/5</div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="grid grid-cols-5 gap-16">
          {encounteredPokemon.map((pokemon, index) => (
            ...
            >
              <div className="text-14 font-bold mb-2">{pokemon.name}</div>
